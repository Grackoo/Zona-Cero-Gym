...
export default function Staff() {
  const staff = [
    { id: 1, name: 'Carlos Mendoza', role: 'Administrador del Sistema', phone: '+1 (555) 019-8234', email: 'carlos@zonacero.com', status: 'EN TURNO', shift: '08:00 - 16:00', img: 'https://i.pravatar.cc/150?u=admin' },
    { id: 2, name: 'Sarah Connor', role: 'Entrenadora Principal', phone: '+1 (555) 019-8235', email: 'sarah@zonacero.com', status: 'EN TURNO', shift: '10:00 - 18:00', img: 'https://i.pravatar.cc/150?u=sarahc' },
    { id: 3, name: 'David Wallace', role: 'Entrenador', phone: '+1 (555) 019-8236', email: 'david@zonacero.com', status: 'FUERA DE TURNO', shift: 'Mañana, 06:00', img: 'https://i.pravatar.cc/150?u=davidw' },
    { id: 4, name: 'Jan Levinson', role: 'Recepcionista', phone: '+1 (555) 019-8237', email: 'jan@zonacero.com', status: 'DE PERMISO', shift: 'Vuelve el 12 Oct', img: 'https://i.pravatar.cc/150?u=janl' },
  ];
                   ...
                   <div className="mt-6 pt-4 border-t border-cero-border flex justify-between items-center">
                     <div>
                       <span className={`text-[10px] font-bold px-2 py-1 rounded uppercase tracking-wider ${
                         person.status === 'EN TURNO' ? 'bg-cero-lime/10 text-cero-lime border border-cero-lime/20' :
